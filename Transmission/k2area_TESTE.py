...
### ...::: IMPORTING PYTHON LIBRARIES/PACKAGES/MODULES :::... ###
import numpy as np
import pandas as pd
...
### ...::: CREATING EMPTY PANDA POWER NETWORK :::... ###
k2area = pp.create_empty_network(name='Kundur2Area',f_hz=60)
### ------------------------------------------------ ###


### ...::: CREATING BUS BARS :::... ### 
# type 'b' for main buses and type 'n' if switches/breakers are added/considered!
pp.create_bus(k2area, vn_kv=20, name='bus1', index=1, geodata=(-1200,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=20, name='bus2', index=2, geodata=(-600,-300), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=20, name='bus3', index=3, geodata=(+1200,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=20, name='bus4', index=4, geodata=(+600,-300), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=230, name='bus5', index=5, geodata=(-900,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=230, name='bus6', index=6, geodata=(-600,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=230, name='bus7', index=7, geodata=(-300,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=230, name='bus8', index=8, geodata=(0,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=230, name='bus9', index=9, geodata=(+300,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=230, name='bus10', index=10, geodata=(+600,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
pp.create_bus(k2area, vn_kv=230, name='bus11', index=11, geodata=(+900,0), type='b', zone=None, in_service=True, max_vm_pu=1.05, min_vm_pu=0.90, coords=None)
### ------------------------------- ###


### ...::: CREATING SLACK BUS :::... ###
pp.create_ext_grid(k2area, pp.get_element_index(k2area, "bus", 'bus4'), vm_pu=1.01, va_degree=-17.0, name='Slack', s_sc_max_mva=2000, rx_max=0.1, rx_min=0.1)
### -------------------------------- ###
...
pp.create_line_from_parameters(k2area, from_bus=7, to_bus=8, length_km=110, r_ohm_per_km=0.0529, x_ohm_per_km=0.529, c_nf_per_km=8.77508, max_i_ka=100, name="110km-B7_B8", index=None, type='ol', geodata=None, in_service=True, df=1.0, parallel=2, g_us_per_km=0.0, alpha=None, temperature_degree_celsius=None)
...
pp.create_line_from_parameters(k2area, from_bus=9, to_bus=8, length_km=110, r_ohm_per_km=0.0529, x_ohm_per_km=0.529, c_nf_per_km=8.77508, max_i_ka=100, name="110km-B9_B8", index=None, type='ol', geodata=None, in_service=True, df=1.0, parallel=2, g_us_per_km=0.0, alpha=None, temperature_degree_celsius=None)
